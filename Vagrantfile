...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "router-1" do |router1|
    ...
    router1.vm.provision "shell", path: "Scripts/router-1.sh"
  ...
  config.vm.define "router-2" do |router2|
    ...
    router2.vm.provision "shell", path: "Scripts/router-2.sh"
  ...
  config.vm.define "host-a" do |hosta|
    ...
    hosta.vm.provision "shell", path: "Scripts/host-a.sh"
  ...
  config.vm.define "host-b" do |hostb|
    ...
    hostb.vm.provision "shell", path: "Scripts/host-b.sh"
  ...
  config.vm.define "host-c" do |hostc|
    ...
    hostc.vm.provision "shell", path: "Scripts/host-c.sh"
